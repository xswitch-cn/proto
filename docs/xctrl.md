...
| memberFilters | [.google.protobuf.ListValue](#xctrl..google.protobuf.ListValue) |  |  |
...
<a name="user-content-xctrl.EventMethod"/>
<a name="xctrl.EventMethod"/>
...
| Invalid | 0 |  |
| NodeRegister | 1 | 节点注册 |
| NodeUnregister | 2 | 节点离线 |
| NodeUpdate | 3 | 节点数据更新 |
| Channel | 4 | 通道 |
| Native | 5 | FreeSWITCH原生消息 |
| Vcc | 6 | old VCC event |
| Result | 7 | 如果API请求有后续事件 |
| DialResult | 8 | 　异步Dial结果 |
| NativeResult | 9 | NativeAPI结果 |
| FetchXML | 10 | 获取配置信息 |
| Dialplan | 11 | 获取Dialplan |
| NativeEvent | 12 | 话机消息 |
| CDR | 13 | 话单 |
| DetectedSpeech | 14 | ASR |
