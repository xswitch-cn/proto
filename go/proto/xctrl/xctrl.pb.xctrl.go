...
type XNodeService interface {
	...
	// 语音识别过程中异步补充TTS文本
	DetectSpeechFeedTTS(ctx context.Context, in *DetectSpeechFeedTTSRequest, opts ...client.CallOption) (*Response, error)
	// 回铃音检测
	...
	// TTS语音合成预缓存
	TTSPreheat(ctx context.Context, in *TTSPreheatRequest, opts ...client.CallOption) (*TTSPreheatResponse, error)
	// Lua
...
func (c *ChannelEvent) ChannelBridge2(in *ChannelBridge2Request, opts ...client.CallOption) *Response {
	if c == nil {
		return &Response{
			Code:    500,
			Message: `Channel is nil`,
	...
	response, err := Service().ChannelBridge2(context.TODO(), in, opts...)
	if err != nil {
		response = new(Response)
		e := errors.Parse(err.Error())
		response.Code = e.Code
...
func (c *xNodeService) DetectSpeechFeedTTS(ctx context.Context, in *DetectSpeechFeedTTSRequest, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "XNode.DetectSpeechFeedTTS", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *xNodeService) TTSPreheat(ctx context.Context, in *TTSPreheatRequest, opts ...client.CallOption) (*TTSPreheatResponse, error) {
	req := c.c.NewRequest(c.name, "XNode.TTSPreheat", in)
	out := new(TTSPreheatResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type XNodeHandler interface {
	...
	// 语音识别过程中异步补充TTS文本
	DetectSpeechFeedTTS(context.Context, *DetectSpeechFeedTTSRequest, *Response) error
	// 回铃音检测
	...
	// TTS语音合成预缓存
	TTSPreheat(context.Context, *TTSPreheatRequest, *TTSPreheatResponse) error
	// Lua
...
func RegisterXNodeHandler(s server.Server, hdlr XNodeHandler, opts ...server.HandlerOption) error {
	type xNode interface {
		...
		DetectSpeechFeedTTS(ctx context.Context, in *DetectSpeechFeedTTSRequest, out *Response) error
		...
		TTSPreheat(ctx context.Context, in *TTSPreheatRequest, out *TTSPreheatResponse) error
...
func (h *xNodeHandler) DetectSpeechFeedTTS(ctx context.Context, in *DetectSpeechFeedTTSRequest, out *Response) error {
	return h.XNodeHandler.DetectSpeechFeedTTS(ctx, in, out)
}
...
func (h *xNodeHandler) TTSPreheat(ctx context.Context, in *TTSPreheatRequest, out *TTSPreheatResponse) error {
	return h.XNodeHandler.TTSPreheat(ctx, in, out)
}
